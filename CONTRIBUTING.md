...
This repository contains an ESLint plugin focused on TypeDoc documentation
quality, validation, and autofix workflows for TypeScript codebases.
...
- `:sparkles: feat(rule): add require-example-tag`

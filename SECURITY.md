...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-typedoc/security/advisories/new>
...
- Keep `eslint-plugin-typedoc`, ESLint, TypeScript, and dependencies updated.
